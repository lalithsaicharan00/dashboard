...
const NotificationSidebar: React.FC<NotificationSidebarProps> = ({
  ...
  return (
    <div
      className="fixed inset-y-0 right-0 w-80 transform transition-transform duration-200 ease-in-out bg-white border-l border-gray-200 shadow-lg z-40"
    >
          ...
          notifications.map(notification => (
            ...
            >
              <button
                ...
                className="absolute top-2 right-2 p-1 rounded-md hover:bg-gray-200 text-gray-500"
              >
                <X className="w-4 h-4" />
              </button>
